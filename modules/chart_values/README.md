...
| alb\_scheme | ALB scheme rendered as awsTurnkey.scheme. | `string` | `"internet-facing"` | no |
| alb\_subnet\_ids | Explicit ALB subnet IDs rendered as awsTurnkey.subnetIds; empty preserves subnet discovery. | `list(string)` | `[]` | no |
