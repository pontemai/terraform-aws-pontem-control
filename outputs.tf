...
output "db_password_secret_name" {
  description = "Secrets Manager name of the database password rendered into helm_values."
  value       = aws_secretsmanager_secret.db_password.name
}

output "device_jwt_signing_key_secret_name" {
  description = "Secrets Manager name of the device-JWT signing key rendered into helm_values."
